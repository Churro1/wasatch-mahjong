...
export const PASS_PRODUCTS: PassProduct[] = [
  {
    ...
    priceCents: 10000,
    totalUses: 6,
    shortDescription: "Six open play nights for one player.",
    benefits: [
      "Use it for 6 open play nights",
      "Only valid for the pass holder",
      "No guests or extra seats",
      "Built to expand into more passes later",
    ],
    openPlayOnly: true,
    selfOnly: true,
  },
